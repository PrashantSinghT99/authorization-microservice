package com.pms.cde.authorization.exception;
...
import com.pms.cde.authorization.custom_annotation.Generated;
import com.pms.cde.authorization.model.ErrorModel;
...
public class ExceptionController extends ResponseEntityExceptionHandler {
	...
	public List<String> lambdaExpressionForFieldErrors(List<FieldError> fieldErrors) {
		return fieldErrors.stream().map(err -> err.getField() + " : " + err.getDefaultMessage())
